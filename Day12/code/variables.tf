...
variable "project"     { description = "Project name"; type = string; default = "day12" }
...
variable "instance_type" { description = "EC2 instance type (workspace-specific)"; type = string; default = "t3.micro" }
